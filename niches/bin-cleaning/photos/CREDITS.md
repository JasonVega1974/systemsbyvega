...
# authorization above still covers their use on a template sold to other
# operators. What was removed instead was the real contact data — the phone,
# email, lead email and the owner's first name are now fictional, and
# marketing/reference/ (their real number and domain) is off the CDN.
# The demo carries a real identity by choice; it carries no real contact.
